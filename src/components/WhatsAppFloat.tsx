...
export const WhatsAppFloat: React.FC = () => {
  return (
    ...
    >
      ...
      {/* Text Label on Hover or desktop */}
      <span className="text-xs font-bold whitespace-nowrap pr-1 hidden sm:inline-block max-w-0 overflow-hidden group-hover:max-w-xs transition-all duration-300 ease-in-out opacity-0 group-hover:opacity-100">
        Chat on WhatsApp
      </span>
    </a>
  );
