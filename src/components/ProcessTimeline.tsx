    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="relative max-w-3xl mx-auto">
          {/* Vertical track */}
          <div className="absolute left-6 sm:left-7 top-2 bottom-2 w-0.5 bg-zinc-800" />
          ...
          <motion.div
            ...
            className="absolute left-6 sm:left-7 top-2 bottom-2 w-0.5 bg-gradient-to-b from-orange-600 via-orange-500 to-amber-400 shadow-[0_0_12px_rgba(249,115,22,0.5)]"
          />
              ...
              return (
                ...
                >
                  ...
                  <motion.div
                    ...
                    className="relative z-10 shrink-0 w-12 h-12 sm:w-14 sm:h-14 rounded-2xl flex items-center justify-center border-2 bg-black border-orange-500"
                  >
                    <span className="absolute -top-1.5 -right-1.5 w-5 h-5 rounded-full bg-orange-500 text-black text-[10px] font-black flex items-center justify-center">
                      {idx + 1}
                    </span>
                  ...
                  <motion.div
                    ...
                    className="flex-1 p-5 sm:p-6 rounded-2xl border shadow-lg shadow-black/40"
                  >
                    <span className="text-[10px] font-black text-orange-500 tracking-wider">STEP {idx + 1}</span>
                    <h3 className="text-base sm:text-lg font-bold mb-1.5 mt-1 text-white">{step.title}</h3>
                    <p className="text-xs sm:text-sm leading-relaxed text-zinc-400">{step.desc}</p>
                  </motion.div>
                </motion.div>
              );
            })}
